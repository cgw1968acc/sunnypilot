...
public:
  ...
  inline float getDistanceToStopTarget() const;
...
public:
  ...
  inline float getDistanceToStopTarget();
  inline void setDistanceToStopTarget(float value);
...
inline float LongitudinalPlanSP::Reader::getDistanceToStopTarget() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<3>() * ::capnp::ELEMENTS, 3212836864u);
}

inline float LongitudinalPlanSP::Builder::getDistanceToStopTarget() {
  return _builder.getDataField<float>(
      ::capnp::bounded<3>() * ::capnp::ELEMENTS, 3212836864u);
}
inline void LongitudinalPlanSP::Builder::setDistanceToStopTarget(float value) {
  _builder.setDataField<float>(
      ::capnp::bounded<3>() * ::capnp::ELEMENTS, value, 3212836864u);
}
