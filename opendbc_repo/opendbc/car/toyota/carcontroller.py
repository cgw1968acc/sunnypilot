...
def get_long_tune(CP, params):
  if CP.carFingerprint in TSS2_CAR:
    if Params().get_bool("ToyotaTSS2Long"):
      #kiBP= [1.5,   5.0,   9.,   12.,  20.,  27.,  36.]
      #kiV  = [0.52, 0.229, 0.16, 0.14, 0.12, 0.101, 0.10]
      kiBP= [0.1,   0.2,   0.3,  1.85,   5.0,   12.,  20.,  27.,  36.]
      kiV  = [0.35, 0.44,  0.52, 0.522, 0.248, 0.142, 0.142, 0.10, 0.09]
    else:
      kiBP = [2., 5.]
      kiV = [0.5, 0.25]
  else:
