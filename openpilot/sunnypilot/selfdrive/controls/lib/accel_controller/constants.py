...
SPEED_RESTRICT_DEADBAND = 0.00
SPEED_RELIEF_DEADBAND = 0.10
TARGET_RELEASE_SLEW = 25
TARGET_SPEED_ARM_MARGIN = 1.0
TARGET_SPEED_RESERVE = 0.00
LAUNCH_TARGET_HEADROOM = 3.5
...
STOPPED_LEAD_SPEED = 0.05
STOP_HOLD_EXIT_SPEED = 0.05
STOP_HOLD_EXIT_FRAMES = 1
STOP_HOLD_CREEP_SPEED = 0.15
STOP_HOLD_CREEP_DISTANCE = 0.30
DEPARTURE_MOTION_NOISE_FLOOR = 0.005
DEPARTURE_MOTION_STEP_MIN = 0.000
