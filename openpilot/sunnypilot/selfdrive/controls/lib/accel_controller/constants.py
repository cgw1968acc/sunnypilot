...
ACCEL_PROFILE_MAX_V = {
  AccelProfile.eco: [1.70, 1.40, 0.50, 0.22, 0.11],
  AccelProfile.normal: [1.95, 1.70, 0.72, 0.36, 0.20],
...
SPEED_RESTRICT_DEADBAND = 0.05 #0.15
SPEED_RELIEF_DEADBAND = 0.20 #0.35
TARGET_RELEASE_SLEW = 12.00 #8.75
TARGET_SPEED_ARM_MARGIN = 1.0
TARGET_SPEED_RESERVE = 0.02 #0.10
LAUNCH_TARGET_HEADROOM = 2.0 #3.0
LAUNCH_TARGET_SLEW = 15.00 #8.75
LAUNCH_END_SPEED = 2.5 #3.0
...
STOP_HOLD_EGO_SPEED = 0.20 #0.30
STOPPED_LEAD_SPEED = 0.20 #0.30
STOP_HOLD_EXIT_SPEED = 0.30 #0.80
STOP_HOLD_EXIT_FRAMES = 1 #4
STOP_HOLD_CREEP_SPEED = 0.15
STOP_HOLD_CREEP_DISTANCE = 0.30
DEPARTURE_MOTION_NOISE_FLOOR = 0.01 #0.03
DEPARTURE_MOTION_STEP_MIN = 0.002 #0.005
