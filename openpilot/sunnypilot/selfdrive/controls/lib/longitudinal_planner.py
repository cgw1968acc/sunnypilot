...
# only targets with no distance or lateral-accel deadline. never add sccVision/sccMap: stretching a curve
# maneuver exceeds the lateral-accel budget it was derived from
