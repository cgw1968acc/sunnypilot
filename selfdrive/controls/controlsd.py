...
class Controls(ControlsExt):
  def __init__(self) -> None:
    ...
    self.LoC = ControlsExt.initialize_longitudinal_control(self, LongControl(self.CP, self.CP_SP))
  ...
  def state_control(self):
    ...
    # Update Torque Params (only when using torque control, not angle)
    ...
    actuators.accel = float(self.long_update(CC.longActive, CS, long_plan.aTarget, long_plan.shouldStop, pid_accel_limits))
