...
def get_a_change_factor(v_ego, v_lead0, v_lead1, personality=custom.LongitudinalPersonalitySP.standard):
  ...
  if personality==custom.LongitudinalPersonalitySP.relaxed:
    ...
    a_change_cost_high_speed_factor = 1.0  # Higher penalty for changes at higher speeds (more cautious)
  elif personality==custom.LongitudinalPersonalitySP.moderate:
    a_change_cost_multiplier_follow = 0.3  # Similar to standard (quicker transitions compared to relaxed)
    a_change_cost_high_speed_factor = 1.0  # Similar to standard (higher penalty for high speeds)
  elif personality==custom.LongitudinalPersonalitySP.aggressive:
