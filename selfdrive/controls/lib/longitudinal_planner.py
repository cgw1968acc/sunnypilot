...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    self.mpc.update(sm['radarState'], v_cruise, x, v, a, j, personality=sm['controlsStateSP'].personality, dynamic_personality=sm['controlsStateSP'].dynamicPersonality, fast_take_off=self.fast_take_off)
