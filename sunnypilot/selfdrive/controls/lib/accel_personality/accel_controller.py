...
MIN_ACCEL_PROFILES = {
  ...
  AccelPersonality.eco:       [-0.50, -0.50, -0.20, -0.25, -0.38, -1.00], #cross
  AccelPersonality.normal:    [-0.55, -0.55, -0.25, -0.30, -0.40, -1.10], #cross
  AccelPersonality.sport:     [-0.60, -0.60, -0.30, -0.35, -0.42, -1.20], #cross
}
