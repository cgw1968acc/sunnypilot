...
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:       [-0.0024, -0.0070, -0.0041, -0.04, -0.22, -0.30, -1.20],
  AccelPersonality.normal:    [-0.0025, -0.0072, -0.0042, -0.05, -0.24, -0.32, -1.25],
  AccelPersonality.sport:     [-0.0026, -0.0074, -0.0043, -0.06, -0.26, -0.34, -1.30],
}
