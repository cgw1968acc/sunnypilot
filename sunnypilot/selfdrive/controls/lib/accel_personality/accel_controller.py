...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-.0008, -.0008, -.008,  -.30,  -1.20],  # gentler braking
  AccelPersonality.normal: [-.0009, -.0009, -.009,  -.34,  -1.20],  # normal braking
  AccelPersonality.sport:  [-.0010, -1.200, -1.20,  -1.2,  -1.20],  # more aggressive braking
}
