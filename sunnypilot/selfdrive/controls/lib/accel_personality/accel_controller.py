...
MAX_ACCEL_V = {
  AccelPersonality.eco:    [2.00, 1.30, 0.80, 0.45, 0.06],
...
FULL_BRAKE_FLOOR_V = {
  AccelPersonality.eco:    [-0.002, -0.4, -0.01, -0.01, -0.42],
  AccelPersonality.normal: [-0.003, -0.5, -0.02, -0.02, -0.60],
  AccelPersonality.sport:  [-0.004, -0.6, -0.03, -0.03, -0.80],
}
