...
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:       [-0.10, -0.12, -0.10, -0.30, -0.44], #cross
  AccelPersonality.normal:    [-0.10, -0.14, -0.12, -0.35, -0.52], #cross
  AccelPersonality.sport:     [-0.14, -0.40, -0.22, -0.40, -0.60], #cross
}
