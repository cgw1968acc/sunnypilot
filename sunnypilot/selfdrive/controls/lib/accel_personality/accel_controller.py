...
MIN_ACCEL_PROFILES = {
  ...
  AccelPersonality.eco:       [-0.36, -0.52, -0.32, -0.32, -1.00], #cross
  AccelPersonality.normal:    [-0.37, -0.56, -0.36, -0.36, -1.10], #cross
  AccelPersonality.sport:     [-0.38, -0.60, -0.40, -0.40, -1.20], #cross
}
