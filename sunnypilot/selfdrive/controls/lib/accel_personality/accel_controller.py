...
MIN_ACCEL_PROFILES = {
  ...
  AccelPersonality.eco:       [-0.36, -0.66, -0.36, -0.36, -1.00], #cross
  AccelPersonality.normal:    [-0.38, -0.68, -0.38, -0.38, -1.10], #cross
  AccelPersonality.sport:     [-0.40, -0.70, -0.40, -0.40, -1.20], #cross
}
