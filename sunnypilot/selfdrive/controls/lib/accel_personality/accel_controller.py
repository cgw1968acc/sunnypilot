...
MAX_ACCEL_V = {
  AccelPersonality.eco:    [2.00, 1.15, 0.54, 0.43, 0.20, 0.15, 0.06],
  AccelPersonality.normal: [2.00, 1.55, 0.93, 0.76, 0.50, 0.40, 0.13],
  AccelPersonality.sport:  [2.00, 1.75, 1.20, 0.95, 0.80, 0.60, 0.22],
}

JERK_ACCEL_BP = [0.0,  40.0]  # m/s
JERK_ACCEL_V  = {
  AccelPersonality.eco:    [0.50, 0.70],
  AccelPersonality.normal: [0.30, 0.50],
  AccelPersonality.sport:  [0.10, 0.50],
}
...
FULL_BRAKE_FLOOR_BP =      [2.0,    4.0,    8.0,   16.,   40.0]  # m/s
...
JERK_DECEL_ONSET = [0.14, 0.06]  # m/s³
