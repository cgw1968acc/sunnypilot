...
MAX_ACCEL_PROFILES = {
  AccelPersonality.eco:      [1.98, 1.97, 1.77, .714, .554, .32, .23, .110],
  AccelPersonality.normal:   [1.99, 1.98, 1.86, .777, .600, .38, .27, .155],
...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.0008, -0.26, -1.20],
  AccelPersonality.normal: [-0.0009, -0.27, -1.30],
  AccelPersonality.sport:  [-0.0010, -0.28, -1.40],
}
