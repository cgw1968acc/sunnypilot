...
MAX_ACCEL_PROFILES = {
  AccelPersonality.eco:      [1.8, 1.75, 1.68, .660, .540, .32, .23, .110],
  AccelPersonality.normal:   [1.9, 1.85, 1.78, .730, .570, .38, .27, .155],
  AccelPersonality.sport:    [2.0, 2.00, 1.90, .960, .800, .60, .40, .200],
}
