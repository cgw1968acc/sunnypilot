...
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:       [-0.10, -0.24, -0.10, -0.30, -0.50], #cross
  AccelPersonality.normal:    [-0.10, -0.33, -0.12, -0.35, -0.52], #cross
  AccelPersonality.sport:     [-0.14, -0.42, -0.14, -0.40, -0.72], #cross
}
