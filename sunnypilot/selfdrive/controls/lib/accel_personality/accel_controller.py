...
MAX_ACCEL_PROFILES = {
  AccelPersonality.eco:       [2.0,  1.98,  1.60, .800, .500, .33, .23, .115],
  AccelPersonality.normal:    [2.0,  1.99,  1.70, .850, .570, .39, .26, .125],
...
MIN_ACCEL_PROFILES = {
  ...
  AccelPersonality.sport:  [-0.08, -0.12, -1.20, -1.20, -1.20],
}
