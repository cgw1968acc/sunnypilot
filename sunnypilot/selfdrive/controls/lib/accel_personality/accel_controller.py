...
MAX_ACCEL_PROFILES = {
  ...
  AccelPersonality.normal:   [1.80, 1.75, 1.65, .760, .525, .38, .27, .155],
...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.008, -0.27, -0.27, -1.20],
  AccelPersonality.normal: [-0.009, -0.33, -0.33, -1.30],
  AccelPersonality.sport:  [-0.010, -0.64, -0.64, -1.40],
}
