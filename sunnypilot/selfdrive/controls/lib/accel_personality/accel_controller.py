...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.0000010, -0.0000010, -0.002, -0.2, -1.20],
  AccelPersonality.normal: [-0.0000015, -0.0000015, -0.003, -0.3, -1.20],
  AccelPersonality.sport:  [-0.0000020, -0.0000020, -0.004, -0.4, -1.20],
}
