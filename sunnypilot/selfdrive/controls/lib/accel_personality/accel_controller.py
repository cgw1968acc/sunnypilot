...
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:       [-0.0023, -0.005, -0.0023, -0.04, -0.22, -0.45, -1.20],
  AccelPersonality.normal:    [-0.0024, -0.006, -0.0033, -0.05, -0.24, -0.55, -1.30],
  AccelPersonality.sport:     [-0.0025, -0.007, -0.0043, -0.06, -0.26, -0.65, -1.40],
}
