...
MIN_ACCEL_PROFILES = {
  ...
  AccelPersonality.eco:       [-0.0021, -0.1400, -0.0072, -0.0070, -0.32, -0.60, -1.00], #cross
  AccelPersonality.normal:    [-0.0022, -0.1600, -0.0075, -0.0071, -0.34, -0.62, -1.10], #cross
  AccelPersonality.sport:     [-0.7700, -0.1800, -0.0078, -0.0072, -0.36, -0.64, -1.20], #cross
}
