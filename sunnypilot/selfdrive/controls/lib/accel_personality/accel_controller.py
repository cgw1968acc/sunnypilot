...
MAX_ACCEL_V = {
  AccelPersonality.eco:    [2.00, 1.30, 0.70, 0.03],
  AccelPersonality.normal: [2.00, 1.50, 0.80, 0.05],
  AccelPersonality.sport:  [2.00, 1.75, 1.20, 0.09],
}
...
FULL_BRAKE_FLOOR_V = {
  AccelPersonality.eco:    [-0.10, -0.16, -0.10, -0.40],
  AccelPersonality.normal: [-0.14, -0.22, -0.14, -0.54],
  AccelPersonality.sport:  [-0.20, -0.32, -0.20, -0.78],
}
