...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-.0001, -.0001, -1.2,  -1.2,  -1.20],  # gentler braking
  AccelPersonality.normal: [-.0002, -.0002, -1.2,  -1.2,  -1.20],  # normal braking
  AccelPersonality.sport:  [-.0003, -.0003, -1.2,  -1.2,  -1.20],  # more aggressive braking
}
