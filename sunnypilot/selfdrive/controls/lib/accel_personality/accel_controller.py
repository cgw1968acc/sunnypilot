...
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:       [-0.0025, -0.0025, -0.005, -0.008, -0.04, -0.22, -0.45, -0.70],
  AccelPersonality.normal:    [-0.0030, -0.0030, -0.006, -0.009, -0.05, -0.24, -0.55, -0.80],
  AccelPersonality.sport:     [-0.0035, -0.0035, -0.007, -0.010, -0.06, -0.26, -0.65, -0.95],
}
