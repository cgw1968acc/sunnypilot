...
MAX_ACCEL_PROFILES = {
  AccelPersonality.eco:       [2.00, 1.80, 1.50, 1.10, 0.78, 0.53, 0.32, 0.08, 0.06],
  AccelPersonality.normal:    [2.40, 2.20, 1.80, 1.40, 0.92, 0.76, 0.38, 0.11, 0.07],
...
MIN_ACCEL_PROFILES = {
  ...
  AccelPersonality.normal:    [-0.08, -0.10, -0.12, -0.52, -0.58],
