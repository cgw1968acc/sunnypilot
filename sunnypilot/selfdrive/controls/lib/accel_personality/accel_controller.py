...
MAX_ACCEL_V = {
  AccelPersonality.eco:    [2.00, 1.30, 0.90, 0.05],
  AccelPersonality.normal: [2.00, 1.50, 1.10, 0.08],
  AccelPersonality.sport:  [2.00, 1.75, 1.40, 0.13],
}
...
FULL_BRAKE_FLOOR_V = {
  AccelPersonality.eco:    [-0.002, -0.004, -0.003, -0.40],
  AccelPersonality.normal: [-0.003, -0.005, -0.004, -0.54],
  AccelPersonality.sport:  [-0.004, -0.006, -0.005, -0.78],
}
