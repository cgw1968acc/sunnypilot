...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-1.2, -1.2, -1.2,  -1.2,  -1.20],  # gentler braking
  AccelPersonality.normal: [-1.2, -1.2, -1.2,  -1.2,  -1.20],  # normal braking
  AccelPersonality.sport:  [-1.24, -1.24, -1.24,  -1.24,  -1.24],  # more aggressive braking
}
