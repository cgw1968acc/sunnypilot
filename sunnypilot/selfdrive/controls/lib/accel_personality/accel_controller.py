...
20
  AccelPersonality.eco:    [1.30, 1.00, 0.52, 0.26, 0.06],
  AccelPersonality.normal: [2.00, 1.50, 1.15, 0.62, 0.13],
  AccelPersonality.sport:  [2.00, 1.75, 1.40, 0.90, 0.20],
}
...
FULL_BRAKE_FLOOR_V = {
  AccelPersonality.eco:    [-0.002, -0.40, -0.1, -0.01, -0.42],
  AccelPersonality.normal: [-0.002, -0.45, -0.2, -0.02, -0.60],
  AccelPersonality.sport:  [-0.002, -0.50, -0.3, -0.03, -0.80],
}
