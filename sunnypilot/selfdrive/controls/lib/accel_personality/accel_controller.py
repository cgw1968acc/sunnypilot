...
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:       [-1.2, -1.2],
  AccelPersonality.normal:    [-1.2, -1.2],
  AccelPersonality.sport:     [-1.3, -1.3],
  ...
  #AccelPersonality.sport:     [-0.0023, -0.6200, -0.0062, -0.0072, -0.18, -0.32, -0.86],
}
