...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-.0030, -.0030, -.060,  -.60,  -1.20],  # gentler braking
  AccelPersonality.normal: [-.0040, -.0040, -.070,  -.70,  -1.20],  # normal braking
  AccelPersonality.sport:  [-.0050, -.0050, -.080,  -.80,  -1.20],  # more aggressive braking
}
