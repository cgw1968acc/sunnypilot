...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-.00001, -.00001, -1.2,  -1.2,  -1.20],  # gentler braking
  AccelPersonality.normal: [-.00003, -.00003, -1.2,  -1.2,  -1.20],  # normal braking
  AccelPersonality.sport:  [-.00005, -.00005, -1.2,  -1.2,  -1.20],  # more aggressive braking
}
