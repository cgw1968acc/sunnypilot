...
MAX_ACCEL_PROFILES = {
  ...
  AccelPersonality.normal:    [2.00, 1.95, 1.60, 1.06, 0.77, 0.66, 0.49, 0.16, 0.12],
  AccelPersonality.sport:     [2.00, 2.00, 1.98, 1.76, 1.24, 0.90, 0.67, 0.50, 0.40],
}
...
MIN_ACCEL_PROFILES = {
  ...
  AccelPersonality.eco:       [-0.32, -0.52, -0.32, -0.32, -1.00], #cross
  AccelPersonality.normal:    [-0.34, -0.54, -0.34, -0.34, -1.10], #cross
  AccelPersonality.sport:     [-0.36, -0.56, -0.36, -0.36, -1.20], #cross
}
MIN_ACCEL_BREAKPOINTS =       [0.0,   2.0,   5.0,   16.0,  40.0]
#MIN_ACCEL_BREAKPOINTS =       [0.0,     1.0,      3.0,     6.0,     10.0,  16.0,  22.0] #corolla only

ACCEL_ALPHA_BASE = 0.99   # responsive for small corrections
ACCEL_ALPHA_MAX = 0.99    # smooth for big transitions
ACCEL_ALPHA_SCALE = 0.99   # How fast alpha grows with error
