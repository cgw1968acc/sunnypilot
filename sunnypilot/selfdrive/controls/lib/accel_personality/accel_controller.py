...
FULL_BRAKE_FLOOR_V = {
  AccelPersonality.eco:    [-0.0007, -0.10, -0.0009, -0.001, -0.42],
  AccelPersonality.normal: [-0.0007, -0.20, -0.0009, -0.001, -0.60],
  AccelPersonality.sport:  [-0.0007, -0.30, -0.0009, -0.001, -0.80],
}
