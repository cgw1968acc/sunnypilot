...
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:       [-0.005, -0.01, -0.02, -0.03, -0.08, -0.25, -0.45, -0.70],
  AccelPersonality.normal:    [-0.008, -0.02, -0.03, -0.04, -0.09, -0.30, -0.55, -0.80],
  AccelPersonality.sport:     [-0.010, -0.03, -0.04, -0.05, -0.10, -0.35, -0.65, -0.95],
}
