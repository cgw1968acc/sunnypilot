...
MAX_ACCEL_PROFILES = {
  AccelPersonality.eco:      [1.96, 1.96, 1.77, .715, .553, .32, .23, .110],
  AccelPersonality.normal:   [1.97, 1.97, 1.84, .773, .600, .38, .27, .155],
  AccelPersonality.sport:    [2.00, 2.00, 1.99, .999, .800, .55, .34, .181],
}
MAX_ACCEL_BREAKPOINTS =      [0.,  4.,   6.,   9.,   16.,  25., 30., 55.]

# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.0008, -0.27, -1.20],
  AccelPersonality.normal: [-0.0009, -0.33, -1.30],
  AccelPersonality.sport:  [-0.0010, -0.64, -1.40],
}
