...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.000001, -0.000001, -0.02, -0.2, -1.20],
  AccelPersonality.normal: [-0.000002, -0.000002, -0.04, -0.4, -1.20],
  AccelPersonality.sport:  [-0.000003, -0.000003, -0.06, -0.6, -1.20],
}
