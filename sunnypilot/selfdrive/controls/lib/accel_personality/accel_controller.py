...
FULL_BRAKE_FLOOR_BP =      [0.0,    4.0,    10.0,   16.,   40.0]  # m/s

FULL_BRAKE_FLOOR_V = {
  AccelPersonality.eco:    [-0.001, -0.01, -0.001, -0.01, -0.42],
  AccelPersonality.normal: [-0.002, -0.02, -0.002, -0.02, -0.60],
  AccelPersonality.sport:  [-0.003, -0.03, -0.003, -0.03, -0.80],
}
