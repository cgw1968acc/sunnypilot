...
# Braking Profiles
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:    [-0.0000002, -0.0000002, -0.002, -0.2, -1.20],
  AccelPersonality.normal: [-0.0000003, -0.0000003, -0.003, -0.3, -1.20],
  AccelPersonality.sport:  [-0.0000004, -0.0000004, -0.004, -0.4, -1.20],
}
