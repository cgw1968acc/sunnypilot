...
# Decel profiles
MIN_ACCEL_BREAKPOINTS =       [2.0,   16.0,  40.0]
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:       [-0.10, -0.30, -0.50], #cross
  AccelPersonality.normal:    [-0.12, -0.33, -0.52], #cross
  AccelPersonality.sport:     [-0.14, -0.40, -1.20], #cross
}
