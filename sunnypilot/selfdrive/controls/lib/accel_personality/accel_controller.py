...
MAX_ACCEL_BP =       [0.0,  3.0,  5.0,  8.0,  12.0, 18.0, 24.0, 32.0, 42.0]
  
MAX_ACCEL_V = {
  AccelPersonality.eco:       [2.00, 1.70, 1.38, 0.74, 0.51, 0.42, 0.33, 0.11, 0.08],
...
JERK_ACCEL_V  = {
  AccelPersonality.eco:    [0.50, 0.60, 0.70, 0.90, 1.00],
  AccelPersonality.normal: [0.40, 0.50, 0.60, 0.80, 0.95],
  AccelPersonality.sport:  [0.30, 0.40, 0.50, 0.70, 0.90],
}
...
FULL_BRAKE_FLOOR_BP = [2.0, 5.0, 10.0, 18.0, 28.0, 40.0]  # m/s

FULL_BRAKE_FLOOR_V = {
  AccelPersonality.eco:    [-0.01, -0.08, -0.22, -0.28, -0.34, -0.40],
  AccelPersonality.normal: [-0.03, -0.09, -0.30, -0.38, -0.46, -0.54],
  AccelPersonality.sport:  [-0.05, -0.10, -0.44, -0.56, -0.68, -0.78],
}
