...
# Decel profiles
MIN_ACCEL_BREAKPOINTS =       [0.0,   2.0,   16.0,  40.0]
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:       [-0.10, -0.10, -0.40, -0.64], #cross
  AccelPersonality.normal:    [-0.12, -0.12, -0.42, -0.76], #cross
  AccelPersonality.sport:     [-1.20, -1.20, -1.20, -1.20], #cross
}
