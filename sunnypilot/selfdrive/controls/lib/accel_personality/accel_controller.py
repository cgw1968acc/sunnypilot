...
MIN_ACCEL_PROFILES = {
  ...
  AccelPersonality.eco:       [-0.10, -0.50, -0.20, -0.32, -1.00], #cross
  AccelPersonality.normal:    [-0.20, -0.55, -0.25, -0.36, -1.10], #cross
  AccelPersonality.sport:     [-0.30, -0.60, -0.30, -0.40, -1.20], #cross
}
