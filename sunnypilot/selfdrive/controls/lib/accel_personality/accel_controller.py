...
A_MAX_V = {
  AccelPersonality.eco:    [1.40, 1.40, 1.20, 0.27, 0.06],
...
A_MIN_FLOOR_V = {
  AccelPersonality.eco:    [-0.002, -0.42, -0.20, -0.03, -0.42],
  AccelPersonality.normal: [-0.002, -0.46, -0.24, -0.05, -0.60],
  AccelPersonality.sport:  [-0.002, -0.50, -0.28, -0.07, -0.80],
}
