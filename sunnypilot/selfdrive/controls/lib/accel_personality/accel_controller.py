...
MIN_ACCEL_PROFILES = {
  ...
  AccelPersonality.eco:       [-0.36, -0.56, -0.36, -0.36, -1.00], #cross
  AccelPersonality.normal:    [-0.38, -0.58, -0.38, -0.38, -1.10], #cross
  AccelPersonality.sport:     [-0.40, -0.60, -0.40, -0.40, -1.20], #cross
}
