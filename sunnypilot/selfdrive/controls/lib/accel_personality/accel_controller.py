...
MAX_ACCEL_V = {
  AccelPersonality.eco:    [2.00, 1.30, 0.90, 0.52, 0.11],
  AccelPersonality.normal: [2.00, 1.50, 1.15, 0.75, 0.15],
  AccelPersonality.sport:  [2.00, 1.75, 1.40, 0.90, 0.35],
}
...
FULL_BRAKE_FLOOR_BP =      [0.0,    5.0,    10.0,   16.,   40.0]  # m/s

FULL_BRAKE_FLOOR_V = {
  AccelPersonality.eco:    [-0.001, -0.003, -0.001, -0.01, -0.42],
  AccelPersonality.normal: [-0.002, -0.004, -0.002, -0.02, -0.60],
  AccelPersonality.sport:  [-0.003, -0.005, -0.003, -0.03, -0.80],
}
