...
MAX_ACCEL_PROFILES = {
  AccelPersonality.eco:       [2.00, 1.80, 1.50, 0.94, 0.60, 0.48, 0.32, 0.08, 0.06],
  AccelPersonality.normal:    [2.40, 2.20, 1.80, 1.20, 0.72, 0.60, 0.38, 0.11, 0.07],
...
# Decel profiles
MIN_ACCEL_BREAKPOINTS =       [2.0,   16.0,  22.0,  25.0]
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:       [-0.02, -0.08, -0.42, -0.48],
  AccelPersonality.normal:    [-0.04, -0.10, -0.52, -0.58],
  AccelPersonality.sport:     [-0.06, -0.12, -0.60, -0.65],
}
