...
MIN_ACCEL_PROFILES = {
  AccelPersonality.eco:       [-0.0022, -0.0600, -0.0060, -0.007, -0.16, -0.30, -0.76],
  AccelPersonality.normal:    [-0.0023, -0.0700, -0.0070, -0.008, -0.17, -0.31, -0.77],
  AccelPersonality.sport:     [-0.0024, -0.0800, -0.0080, -0.009, -0.18, -0.32, -0.78],
}
