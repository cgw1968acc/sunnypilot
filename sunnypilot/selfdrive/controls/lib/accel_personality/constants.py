...
ACCEL_PROFILE_MAX_V = {
  AccelProfile.eco:    [1.60, 1.10, 0.30, 0.075, 0.06], 
  AccelProfile.normal: [1.85, 1.80, 0.77, 0.23, 0.12],  
...
LEAD_MATCH_GAP_GAIN = 0.01
LEAD_MATCH_SPEED_HEADROOM = 1.75
LEAD_MATCH_TAPER_GAIN = 2.00
LEAD_MATCH_ACCEL_SLEW = 0.18
