...
STOCK_A_CRUISE_MAX_V = [1.8, 0.80, 0.2, 0.08]
STOCK_RISE_RATE = 0.05
A_CRUISE_MAX_V = {
  ECO:    [1.60, 0.40, 0.12, 0.05],   # stock launch (v=0), gentle cruise (25/40)
