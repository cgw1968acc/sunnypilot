...
FOLLOW_PROFILES = {
  LongPersonality.relaxed:    [1.35, 1.35, 1.45, 1.53, 1.80, 2.00],
  LongPersonality.standard:   [1.25, 1.25, 1.31, 1.36, 1.45, 1.55],
  LongPersonality.aggressive: [0.90, 0.90, 1.10, 1.14, 1.15, 1.20],
}
