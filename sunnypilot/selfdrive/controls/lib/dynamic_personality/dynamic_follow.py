...
FOLLOW_PROFILES = {
  LongPersonality.relaxed:    [1.30, 1.30, 1.405, 1.40, 1.80, 1.75],
  LongPersonality.standard:   [1.15, 1.15, 1.285, 1.28, 1.45, 1.43],
  LongPersonality.aggressive: [0.97, 0.95, 1.110, 1.09, 1.17, 1.15],
}
