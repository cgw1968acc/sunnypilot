...
FOLLOW_PROFILES = {
  LongPersonality.relaxed:    [1.30, 1.30, 1.40, 1.40, 1.80],
  LongPersonality.standard:   [1.15, 1.15, 1.28, 1.28, 1.45],
  LongPersonality.aggressive: [0.94, 0.94, 1.06, 1.06, 1.15],
}

FOLLOW_BREAKPOINTS =          [0.,   5.,   6,    16.,  22.]
