...
FOLLOW_PROFILES = {
  LongPersonality.relaxed:    [1.60, 1.752, 1.75, 1.75, 1.90, 1.90, 1.89],
  LongPersonality.standard:   [1.42, 1.452, 1.45, 1.45, 1.54, 1.54, 1.53],
  LongPersonality.aggressive: [0.85, 1.252, 1.25, 1.25, 1.28, 1.28, 1.25],
}
