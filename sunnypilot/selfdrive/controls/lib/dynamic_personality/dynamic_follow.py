...
FOLLOW_PROFILES = {
  LongPersonality.relaxed:    [1.25, 1.30, 1.550, 1.55, 1.89],
  LongPersonality.standard:   [1.14, 1.15, 1.400, 1.40, 1.45],
  LongPersonality.aggressive: [0.97, 0.97, 1.200, 1.20, 1.28],
}

FOLLOW_BREAKPOINTS =          [0.,   3.,   4,    16.,   36]
