...
FOLLOW_PROFILES = {
  LongPersonality.relaxed:    [1.40, 1.80],  # more spread out
  LongPersonality.standard:   [1.30, 1.55],  # balanced
  LongPersonality.aggressive: [1.20, 1.35],  # tighter
}
FOLLOW_BREAKPOINTS = [0., 36.]
