...
FOLLOW_PROFILES = {
  LongPersonality.relaxed:    [1.60, 1.62, 1.75, 1.75, 1.90, 1.90, 1.89],
  LongPersonality.standard:   [1.43, 1.45, 1.45, 1.45, 1.54, 1.54, 1.53],
  LongPersonality.aggressive: [0.85, 0.87, 1.17, 1.17, 1.25, 1.25, 1.24],
}
