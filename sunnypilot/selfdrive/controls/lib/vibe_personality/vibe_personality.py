...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.0006, -.0006, -.10,  -1.00,  -1.00],  # gentler braking
    LongPersonality.standard:   [-.0007, -.0007, -.14,  -1.10,  -1.10],  # normal braking
    LongPersonality.aggressive: [-.0008, -.0008, -.18,  -1.20,  -1.20],  # more aggressive braking
}
