...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.5000, -1.1],  # gentler braking
    LongPersonality.standard:   [-.6000, -1.2],  # normal braking
    LongPersonality.aggressive: [-.7000, -1.2],  # more aggressive braking
}
