...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.010, -1.1, -1.1, -1.1],  # gentler braking
    LongPersonality.standard:   [-.015, -1.2, -1.2, -1.2],  # normal braking
    LongPersonality.aggressive: [-.020, -1.2, -1.2, -1.2],  # more aggressive braking
}
