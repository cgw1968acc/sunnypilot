...
MAX_ACCEL_PROFILES = {
    AccelPersonality.eco:       [2.0,  1.90,  1.70, 1.10, .500, .292, .13, .09],   # eco
    AccelPersonality.normal:    [2.0,  1.98,  1.88, 1.22, .635, .33, .18, .14],   # normal
...
FOLLOW_PROFILES = {
    ...
    LongPersonality.aggressive: [1.06, 1.11, 1.08, 1.17, 1.17, 1.25, 1.27],  # tighter
}
