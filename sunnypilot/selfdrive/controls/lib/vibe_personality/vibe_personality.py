...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.0007, -.0007, -.06,  -1.00,  -1.00],  # gentler braking
    LongPersonality.standard:   [-.0008, -.0008, -.08,  -1.10,  -1.10],  # normal braking
    LongPersonality.aggressive: [-.0009, -.0009, -.10,  -1.20,  -1.20],  # more aggressive braking
}
