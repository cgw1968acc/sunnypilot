...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-0.08, -0.4, -0.6, -1.1],  # gentler braking
    LongPersonality.standard:   [-0.1, -0.6, -0.8, -1.2],  # normal braking
    LongPersonality.aggressive: [-0.2, -0.8, -1.0, -1.2],  # more aggressive braking
}
