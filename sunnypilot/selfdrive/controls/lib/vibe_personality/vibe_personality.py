...
FOLLOW_PROFILES = {
    LongPersonality.relaxed:    [1.55, 1.55, 1.55, 1.65, 1.65, 1.80, 1.80],  # more spread out
    LongPersonality.standard:   [1.40, 1.40, 1.40, 1.45, 1.45, 1.50, 1.50],  # balanced
    LongPersonality.aggressive: [1.06, 1.06, 1.06, 1.17, 1.17, 1.25, 1.27],  # tighter
}
