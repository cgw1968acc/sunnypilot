...
MIN_ACCEL_PROFILES = {
  LongPersonality.relaxed:    [-0.10, -1.0, -1.0],  # gentler braking
  LongPersonality.standard:   [-0.10, -1.1, -1.1],  # normal braking
  LongPersonality.aggressive: [-0.10, -1.2, -1.2],  # more aggressive braking
}
