...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.002, -.002, -.4, -1.1],  # gentler braking
    LongPersonality.standard:   [-.003, -.003, -.5, -1.2],  # normal braking
    LongPersonality.aggressive: [-.004, -.004, -.6, -1.2],  # more aggressive braking
}
