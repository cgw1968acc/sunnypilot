...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.0009, -.0009, -.42,  -1.20,  -1.20],  # gentler braking
    LongPersonality.standard:   [-.0011, -.0011, -.44,  -1.22,  -1.22],  # normal braking
    LongPersonality.aggressive: [-.0013, -.0013, -.46,  -1.24,  -1.24],  # more aggressive braking
}
