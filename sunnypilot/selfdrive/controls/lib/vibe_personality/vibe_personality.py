...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.0007, -.0007, -.020,  -.40,  -1.20],  # gentler braking
    LongPersonality.standard:   [-.0008, -.0008, -.022,  -.50,  -1.20],  # normal braking
    LongPersonality.aggressive: [-.0009, -.0009, -.024,  -.60,  -1.20],  # more aggressive braking
}
