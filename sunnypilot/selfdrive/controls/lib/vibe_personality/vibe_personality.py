...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.0007, -.0007, -.010,  -.30,  -1.20],  # gentler braking
    LongPersonality.standard:   [-.0008, -.0008, -.012,  -.35,  -1.20],  # normal braking
    LongPersonality.aggressive: [-.0009, -.0009, -.014,  -.40,  -1.20],  # more aggressive braking
}
