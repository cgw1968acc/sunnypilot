...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-0.008, -.6000, -1.1],  # gentler braking
    LongPersonality.standard:   [-0.009, -.8000, -1.2],  # normal braking
    LongPersonality.aggressive: [-0.010, -1.000, -1.2],  # more aggressive braking
}
