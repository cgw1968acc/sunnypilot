...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.08, -1.1, -1.1, -1.1],  # gentler braking
    LongPersonality.standard:   [-0.1, -1.2, -1.2, -1.2],  # normal braking
    LongPersonality.aggressive: [-0.2, -1.2, -1.2, -1.2],  # more aggressive braking
}
MIN_ACCEL_BREAKPOINTS =       [0.,  19.9,   20.,  50.]
...
def get_dynamic_personality(v_ego, personality):
    ...
    scale_factor = np.interp(v_ego, [0, 22, 36], [1.0, 1.0, 1.2])
