...
MAX_ACCEL_PROFILES = {
  AccelPersonality.eco:       [2.00, 2.0,  1.92, 1.23, .52,  .285, .16, .10],  # eco
  AccelPersonality.normal:    [2.00, 2.0,  1.98, 1.45, .60,  .295, .20, .16],   # normal
  AccelPersonality.sport:     [2.00, 2.0,  2.00, 1.65, .80,  .333, .28, .2],   # sport
}
...
def get_dynamic_personality(v_ego, personality):
    ...
    scale_factor = np.interp(v_ego, [0, 5, 18, 36], [.6, 1.0, 1.0, 1.2])
