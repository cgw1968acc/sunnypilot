...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.02, -1.1, -1.1, -1.1],  # gentler braking
    LongPersonality.standard:   [-.03, -1.2, -1.2, -1.2],  # normal braking
    LongPersonality.aggressive: [-.04, -1.2, -1.2, -1.2],  # more aggressive braking
}
