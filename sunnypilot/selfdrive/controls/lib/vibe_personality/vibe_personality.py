...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.0009, -.0009, -.20,  -1.00,  -1.00],  # gentler braking
    LongPersonality.standard:   [-.0011, -.0011, -.24,  -1.10,  -1.10],  # normal braking
    LongPersonality.aggressive: [-.0013, -.0013, -.28,  -1.20,  -1.20],  # more aggressive braking
}
