...
MIN_ACCEL_PROFILES = {
    LongPersonality.relaxed:    [-.0008, -.0008, -.1,  -.4,  -1.2,  -1.2],  # gentler braking
    LongPersonality.standard:   [-.0012, -.0012, -.2,  -.5,  -1.2,  -1.2],  # normal braking
    LongPersonality.aggressive: [-.0020, -.0020, -.3,  -.6,  -1.2,  -1.2],  # more aggressive braking
}
